...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _RequestFile_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RequestFile.vue */ "./resources/js/main/components/forms/RequestFile.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    RequestFile: _RequestFile_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
      files: []
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _RequestUploadFile_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./RequestUploadFile.vue */ "./resources/js/main/components/forms/RequestUploadFile.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    RequestUploadFile: _RequestUploadFile_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  props: {
    ureslist: {
      type: Array,
  ...
  methods: {
    SuccessUser: function SuccessUser(e) {
      ...
      if (e) {
        ...
        setTimeout(function () {
          _this.$refs.user.classList.add('invisible');
        }, 1000);
        this.$refs.request.classList.remove('invisible');
        setTimeout(function () {
          _this.$refs.requeststep.$refs.description_field.$el.focus();
        }, 1300);
      }
    },
    SuccessRequest: function SuccessRequest(e) {
      var _this2 = this;
    ...
    PrevUser: function PrevUser(e) {
      ...
      if (e) {
        ...
        setTimeout(function () {
          _this3.$refs.request.classList.add('invisible');
        }, 1000);
        this.$refs.user.classList.remove('invisible');
        setTimeout(function () {
          _this3.$refs.userstep.$refs.email_field.$el.focus();
        }, 1300);
      }
    },
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.files, function(file, key) {
      return _c(
        "div",
        { key: key, staticClass: "card mb-4", attrs: { value: file.name } },
        [
          ...
          _c("div", { staticClass: "card__body card--file" }, [
            ...
            _c("div", { staticClass: "form-control m-0" }, [
              _c(
                ...
                [_vm._v("Descripción del archivo "), _vm._m(1, true)]
              ),
              _vm._v(" "),
              _c("input", {
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "text-center" }, [
        ...
        _c(
          "a",
          { staticClass: "request--link size-sm", attrs: { href: "#" } },
  ...
  return _c(
    ...
    [
      ...
      _vm.files.length > 0
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "form-control mb-18" }, [
        _c(
          "label",
          {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { ref: "request_form" }, [
    _vm.successSteps == false
      ? _c("div", { ref: "steprequest", staticClass: "request__form" }, [
          _c(
            "div",
            ...
            [
              _c(
                ...
                {
                  ref: "userstep",
                  attrs: { action: _vm.urluser, ureslist: _vm.ureslist },
                  on: { successuser: _vm.SuccessUser, requestid: _vm.GetID }
                },
                [_c("template", { slot: "continue" }, [_vm._t("continue")], 2)],
                2
              )
            ],
            1
          ...
          _c(
            ...
            [
              _c(
                ...
                {
                  ref: "requeststep",
                  attrs: { action: _vm.urlrequest, requestid: _vm.requestid },
                  on: {
                ...
                [
                  _c("template", { slot: "return" }, [_vm._t("return")], 2),
                  _vm._v(" "),
                  _c(
                    "template",
                    { slot: "paperclip" },
      ...
      : _c("div", { ref: "stepsucess", staticClass: "successRequest" }, [
          _c("div", { staticClass: "text-center alert__request--success" }, [
            _c(
              "span",
            ...
            _vm._v(" "),
            _c("p", { staticClass: "text-center size-normal mb-8 mt-4" }, [
              _vm._v("Tu solicitud ha sido creada")
            ])
          ]),
          _vm._v(" "),
          _c("h4", { staticClass: "text-center mb-6 color-gray-70" }, [
          ...
          _vm.otherEmail == true
            ? _c(
                "p",
                {
                  staticClass: "alert alert--info alert--has-icon mt-8 size-sm"
                },
                [
                  _vm._v(
...
var staticRenderFns = [
  function() {
    ...
    return _c("p", [
      ...
      _c("a", { staticClass: "request--link", attrs: { href: "#" } }, [
      ...
      [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.ureslist, function(ures) {
              return _c("option", { domProps: { value: ures.id } }, [
                _vm._v(
                  "\n                " +
                    _vm._s(ures.ures_descrip) +
                    "\n            "
                )
              ])
            })
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._t("default", [_vm._v("- Selecciona una opción -")])],
        2
      ),
      _vm._v(" "),
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "container main-menu__container" }, [
        _c(
          ...
          [
            _c("img", {
              attrs: {
                src: _vm.$root.path + "/static/img/header/logo-dtd.png",
      ...
      _vm._v(" "),
      _c("div", { staticClass: "main-menu__list--container" }, [
        _c(
          "ul",
          {
            ref: "list",
          ...
          [
            ...
            _c(
              "li",
              {
                ...
                class: {
                  "main-menu__li--open": _vm.menuIsOpen,
                  "main-menu__li--closed": !_vm.menuIsOpen && _vm.buttonClicked
                }
              },
              [
                _c(
                  ...
                  {
                    staticClass: "js-item main-menu__link",
                    attrs: { href: this.$root.path + "/ingresar" },
                    on: {
                      keydown: function($event) {
                        if (
                          !$event.type.indexOf("key") &&
...
/***/ 0:
/*!************************************************************!*\
  !*** multi ./resources/js/main ./resources/sass/main.scss ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\Ramon\Desktop\digital-front\resources\js\main */"./resources/js/main/index.js");
module.exports = __webpack_require__(/*! C:\Users\Ramon\Desktop\digital-front\resources\sass\main.scss */"./resources/sass/main.scss");
