    ...
    addFile: function addFile() {
      ...
      window.axios.post('subir-archivo', formData).then(function (response) {
        if (response.data.id) {
          ...
          _this.$set(_this.$parent.thumbs, key, response.data.file);
...
var render = function() {
  ...
  return _c("div", { staticClass: "m-auto d-flex justify-center" }, [
    _c(
      "span",
      {
        ...
        class: {
          ...
          "request__step--success__reverse": _vm.step === 0 && !_vm.isRight
        }
      },
      [
        _c(
    ...
    _vm._v(" "),
    _c("span", {
      staticClass: "request__progress opacity-0",
      class: {
        "request__progress--active": _vm.step === 1 && _vm.isRight,
        "request__progress--active__reverse": _vm.step === 1 && !_vm.isRight
      }
    }),
    _vm._v(" "),
    _c(
      "span",
      {
        staticClass: "request__step",
        class: {
          "request__step--active": _vm.step === 1,
          "request__step--success": _vm.step === 2
        }
      },
      [
        _c(
